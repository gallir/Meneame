...
function check_stats($string)
{
    ...
    if (preg_match('/^!bloggers/', $string)) {
        return do_bloggers($string);
    }
    if (preg_match('/^!last/', $string)) {
        return do_last($string);
    }
    if (preg_match('/^!gs/', $string)) {
        return do_fon_gs($string);
    }
    if (preg_match('/^!rae/', $string)) {
        return do_rae($string);
    }
    if (preg_match('/^!values/', $string)) {
        return do_values();
    }
    if (preg_match('/^!load/', $string)) {
        return do_load();
    }
    return false;
}
