...
class Link extends LCPBase
{
    ...
    public function store()
    {
        ...
        $r = $db->query("UPDATE links set link_url='$link_url', link_uri='$link_uri', link_url_title='$link_url_title', link_title='$link_title', link_content='$link_content', link_tags='$link_tags', link_thumb_status='$link_thumb_status', link_nsfw=$link_nsfw WHERE link_id=$this->id");
