<?php
	global $globals;
	if(empty($globals['db_name'])) $globals['db_name'] = 'meneame';
	if(empty($globals['db_user'])) $globals['db_user'] = 'meneame';
	if(empty($globals['db_server'])) $globals['db_server'] = 'localhost';
	...
	class db {
		...
		function db()
		{
			...
			if ($globals['mysql_persistent']) {
				$this->dbh = @mysql_pconnect($globals['db_server'],$globals['db_user'],$globals['db_password']);
			} else {
				$this->dbh = @mysql_connect($globals['db_server'],$globals['db_user'],$globals['db_password']);
			}
