...
class Upload
{
    ...
    public static function current_user_limit_exceded($size)
    {
    ...
    public static function user_uploads($user, $hours = false, $type = false)
    {
        global $db;
    ...
    public function __construct($type, $id, $version = 0, $time = false)
    {
        global $globals;
    ...
    public function from_temporal($file, $type = false)
    {
        global $current_user, $globals;
    ...
    public function from_tmp_upload($filename, $type)
    {
        global $current_user, $globals;
    ...
    public function from_form($field, $type = false)
    {
