...
// Example for nginx:
// rewrite /v_\d+/(.+)$ /$1 last;
$globals['v'] = 37; // internal version, to for reloads
...
$globals['jquery'] = '//ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js';
$globals['jquery2'] = '//ajax.googleapis.com/ajax/libs/jquery/2.1.3/jquery.min.js';
