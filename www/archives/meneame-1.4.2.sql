...
-- ------------------------------------------------------
-- Server version	5.0.24-Debian_3-log
...
) ENGINE=MyISAM AUTO_INCREMENT=13132 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
CREATE TABLE `comments` (
  ...
  `comment_nick` char(32) collate utf8_spanish_ci NOT NULL,
...
) ENGINE=MyISAM AUTO_INCREMENT=142718 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
) ENGINE=MyISAM AUTO_INCREMENT=36230 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
) ENGINE=MyISAM AUTO_INCREMENT=8912 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
CREATE TABLE `users` (
  ...
  `user_names` char(80) collate utf8_spanish_ci NOT NULL,
...
) ENGINE=MyISAM AUTO_INCREMENT=10313 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
CREATE TABLE `votes` (
  ...
  KEY `vote_type_3` (`vote_type`,`vote_date`),
  KEY `vote_type_4` (`vote_type`,`vote_date`,`vote_user_id`)
) ENGINE=MyISAM AUTO_INCREMENT=1305134 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci PACK_KEYS=0;
