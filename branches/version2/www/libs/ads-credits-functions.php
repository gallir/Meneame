...
// 	echo '<br style="clear: both;" />' . "\n";
	...
	echo '<a href="'.$globals['base_url'].'faq-'.$dblang.'.php#we">'._('quiénes somos').'</a>&nbsp;&nbsp;|&nbsp;&nbsp;Alojamiento web en <a href="http://www.ferca.com">Ferca Network</a><br />'; // delete this link, is a meneame.net sponsor!<br />';
