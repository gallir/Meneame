...
function do_header($title, $id='home') {
	...
	echo '<div id="logo">'  . "\n";
	echo '<a href="'.$globals['base_url'].'" title="¡cumplimos un año! (7-12-2006). ¿le has tirado de la oreja?"><img src="'.$globals['base_url'].'img/es/logo01.png" alt="menéame, noticias colaborativas" /></a>';
	echo '</div>'  . "\n";
