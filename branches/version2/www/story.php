...
function print_comment_form() {
	...
	//echo '<p>'."\n";
	echo '<label for="comment" accesskey="2" style="float:left"><span class="comments-warning">'._('insultos, difamaciones y frases racistas causarán la anulación de la cuenta').'</span><br />'._('entra el texto del comentario / no se admiten etiquetas HTML').'</label>'."\n";
	//echo '</p>';
