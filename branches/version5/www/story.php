...
if ($site_id != $link->sub_id && (empty($link->sub_status) || ! $link->allow_main_link)) {
...
$globals['extra_head'] .= '<link rel="alternate" type="application/rss+xml" title="'._('comentarios esta noticia').'" href="http://'.get_server_name().$globals['base_url'].'comments_rss?id='.$link->id.'" />';
