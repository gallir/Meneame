...
$globals['js_main'] = 'general.js.php?v=27'; //?N is to force reloading for newer versions
// CSS files (main, color, notame)
//$globals['css_main'] = 'css/es/mnm.css?v=29'; //?N is to force reloading for newer versions
$globals['css_main'] = 'css/es/mnm-qdq.css?v=29'; //?N is to force reloading for newer versions
