...
$globals['js_main'] = 'general.js.php?v=13'; //?N is to force reloading for newer versions
// CSS files (main, color, notame)
$globals['css_main'] = 'css/es/mnm.css?v=21'; //?N is to force reloading for newer versions
