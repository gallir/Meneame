...
$globals['js_main'] = 'general.js.php?v=31'; //?N is to force reloading for newer versions
// CSS files (main, color, notame)
$globals['css_main'] = 'css/es/mnm.css?v=33'; //?N is to force reloading for newer versions
