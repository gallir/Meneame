...
if ($vote->value > 0) $dict['image'] = $globals['static_server'].$globals['base_url'].'img/common/vote-up-gy01.png';
else $dict['image'] = $globals['static_server'].$globals['base_url'].'img/common/vote-down-gy01.png';
