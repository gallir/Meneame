...
function print_index_tabs($option=-1) {
	...
	switch ($option) {
		case 0: // All, published
			echo '<li><a class="teaser" href="'.$globals['base_url'].'rss2.php" rel="rss"><img class="tabsub-shakeit-icon" src="'.$globals['base_url'].'img/common/feed-icon-12x12.png" width="12" height="12" alt="rss2"/></a></li>';
			break;
		case 7: // Personalised, published
			echo '<li><a class="teaser" href="'.$globals['base_url'].'rss2.php?personal='.$current_user->user_id.'" rel="rss"><img class="tabsub-shakeit-icon" src="'.$globals['base_url'].'img/common/feed-icon-12x12.png" width="12" height="12" alt="rss2"/></a></li>';
			break;
		default:
			echo '<li><a class="teaser" href="'.$globals['base_url'].'rss2.php?meta='.$globals['meta_current'].'" rel="rss"><img class="tabsub-shakeit-icon" src="'.$globals['base_url'].'img/common/feed-icon-12x12.png" width="12" height="12" alt="rss2"/></a></li>';
	}
