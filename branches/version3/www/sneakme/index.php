...
function do_post_subheader($content, $selected = false, $rss = false, $rss_title = '') {
	...
	if ($current_user->user_id > 0 ) {
		if (Post::can_add($current_user->user_id)) {
			echo '<li class="selected"><span><a class="toggler" href="javascript:post_new()" title="'._('nueva nota').'">'._('nueva nota').'&nbsp;<img src="'.$globals['base_static'].'img/common/icon_add_post_001.png" alt="" width="10" height="12"/></a></span></li>';
		} else {
