...
echo '<link rel="stylesheet" type="text/css" media="screen" href="'.$globals['static_server'].$globals['base_url'].'css/es/telnet.css" />' . "\n";
echo '<link rel="icon" href="'.$globals['static_server'].$globals['base_url'].'img/common/konsole.png" type="image/x-icon" />' . "\n";
do_js_includes();
echo '</head>' . "\n";
echo "<body>\n";
