...
function do_credits() {
	...
	if ($globals['is_meneame']) {
		...
		echo '<li><a href="http://websvn.meneame.net/listing.php?repname=meneame&path=/version3/">'._('descargar código').'</a></li>';
	} else {
	...
	echo '<li><a href="http://feedvalidator.org/check.cgi?url=http://meneame.net/rss2.php"><img style="border:0;width:80px;height:15px" src="'.$globals['base_static'].'img/common/valid-rss.gif" alt="Valid RSS" title="Validate my RSS feed" /></a></li>';
	echo '</ul>';
	echo '</div>'."\n";
