...
if (preg_match('/SymbianOS|BlackBerry|iPhone|Mobile|Opera Mini|\/MIDP|Portable|webOS/i', $_SERVER['HTTP_USER_AGENT']) 
		&& ! preg_match('/(pad|tablet)\W/i', $_SERVER['HTTP_USER_AGENT']) ) {
	$globals['mobile'] = true;
}
