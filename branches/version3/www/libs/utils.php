...
define('META_YES', '<img class="tabsub-shakeit-img" src="'.$globals['base_url'].'img/common/fix-01.png" alt="del" width="13" height="13" title="'._('filtrar como tema por defecto').'"/>');
define('META_NO', '<img class="tabsub-shakeit-img" src="'.$globals['base_url'].'img/common/fix-02.png" alt="del" width="13" height="13" title="'._('filtrar como tema por defecto').'"/>');
