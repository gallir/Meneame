...
function do_header($title, $id='home') {
	...
	static $hello = array("bienvenid@","hola","kaixo","apa","epa","aupa","ieup","gñap","aiya","hello","uep","hey","passa","hi","wachipei hunga hunga","salut","bonjour","hallo","guten tag","moin moin","Dobrý deň","helo","xitsonga","minjhani","kunjhani","moshi moshi","ciao","hej","god dag","have a nice day","as-salaam-aleykum","marhabah","sabbah-el-khair","salaam or do-rood","namaste","ahn nyeong ha se yo","ahn nyeong","hallo","goedendag","priviet","zdravstvuyte","ni hao","nei ho","shalom","hei","oi","olá","hej","god dag","mingalarbar","merhaba","chao","kumusta ka","saluton","vanakkam","jambo","mbote","namaskar","dzień dobry","cześć","aloha","jo napot","szervusz","dobriy ranok","labdien","sveiki","chau","hyvää päivää","moi","hei","yia sou","yia sas","góðan dag","hæ","ellohay","namaskkaram","adaab","baagunnara","niltze","hao","bok","ya'at'eeh","merħba","mambo","salamaleikum","grüzi","haj","hallå","moïen","talofa","malo","malo e leilei","la orana","kia ora","buna ziua","kem che","namaskar","sawa dee krap/ka","kanien'kéha","kwe kwe","hola oh","hâu","vary");
...
<<<<<<< .mine
=======
		$hello = array("bienvenid@","hola","kaixo","apa","epa","aupa","ieup","gñap","aiya","hello","uep","hey","passa","hi","hunga hunga","salut","bonjour","hallo","guten tag","moin moin","Dobrý deň","helo","xitsonga","minjhani","kunjhani","moshi moshi","ciao","hej","god dag","have a nice day","as-salaam-aleykum","marhabah","sabbah-el-khair","salaam or do-rood","namaste","ahn nyeong ha se yo","ahn nyeong","hallo","goedendag","priviet","zdravstvuyte","ni hao","nei ho","shalom","hei","oi","olá","hej","god dag","mingalarbar","merhaba","chao","kumusta ka","saluton","vanakkam","jambo","mbote","namaskar","dzień dobry","cześć","aloha","jo napot","szervusz","dobriy ranok","labdien","sveiki","chau","hyvää päivää","moi","hei","yia sou","yia sas","góðan dag","hæ","ellohay","namaskkaram","adaab","baagunnara","niltze","hao","bok","ya'at'eeh","merħba","mambo","salamaleikum","grüzi","haj","hallå","moïen","talofa","malo","malo e leilei","la orana","kia ora","buna ziua","kem che","namaskar","sawa dee krap/ka","kanien'kéha","kwe kwe","hola oh","hâu","vary");
		/* from http://es.wikihow.com/decir-hola-en-diferentes-idiomas  thanks! */
>>>>>>> .r1442
