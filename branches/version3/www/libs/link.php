...
class Link {
	...
	function get($url, $maxlen = 150000, $check_local = true) {
		...
		if(version_compare(phpversion(), '5.0.0') >= 0) {
			$opts = array(
				'http' => array('user_agent' => 'Meneamebot (http://meneame.net/)', 'max_redirects' => 10, 'timeout' => 10, 'header' => 'Referer: http://'.get_server_name().$globals['base_url']."\r\n" ),
				'https' => array('user_agent' => 'Meneamebot (http://meneame.net/)', 'max_redirects' => 10, 'timeout' => 10, 'header' => 'Referer: http://'.get_server_name().$globals['base_url']."\r\n" ),
			);
