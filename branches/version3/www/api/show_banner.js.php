...
var mnm_banner_url = 'http://<?echo  preg_replace('/[ <>\'\"\r\n\t\(\)]/', '', stripslashes($_SERVER['SERVER_NAME'])); ?>/api/show_banner.php?width='+mnm_banner_width+'&height='+mnm_banner_height+'&format='+mnm_banner_format+'&color_border='+mnm_banner_color_border+'&color_bg='+mnm_banner_color_bg+'&color_link='+mnm_banner_color_link+'&color_text='+mnm_banner_color_text+'&font_pt='+mnm_banner_font_pt;
